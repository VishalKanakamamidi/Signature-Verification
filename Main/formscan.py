...
txt = ("imgscan/accno.jpg")
accno = scan(txt)
print("Date on which form was filled")
txt = ("imgscan/date-d.jpg")
dated = scan(txt)
txt = ("imgscan/date-m.jpg")
datem = scan(txt)
txt = ("imgscan/date-y.jpg")
datey = scan(txt)
print("Mandate Start Date")
txt = ("imgscan/from-d.jpg")
fromd = scan(txt)
txt = ("imgscan/from-m.jpg")
fromm = scan(txt)
txt = ("imgscan/from-y.jpg")
fromy = scan(txt)
print("Mandate End Date")
txt = ("imgscan/to-d.jpg")
tod = scan(txt)
txt = ("imgscan/to-m.jpg")
tom = scan(txt)
txt = ("imgscan/to-y.jpg")
toy = scan(txt)
...
c=('imgscan/original/original.jpg')
original= cv2.imread(c)
        
sample = []
for x in range(number):
        f=x+1
        c=('imgscan/sig%d.jpg'%(f))
        e= cv2.imread(c)
        sample.append(e)
